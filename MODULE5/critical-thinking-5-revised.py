...
# Part 2: Bookstore Points Calculation with Range Handling

number_of_books_procured = int(input("How Many Books are Procured This Month: "))

if number_of_books_procured >= 8:
    numeral_of_points_earned = 60
elif 6 <= number_of_books_procured < 8:
    numeral_of_points_earned = 30
elif 4 <= number_of_books_procured < 6:
    numeral_of_points_earned = 15
elif 2 <= number_of_books_procured < 4:
