...
class ItemToProcure:
    ...
    def console_log_product_cost(self):
        totatl_grocery_cart_cost = self.dollar_value_of_product * self.numerical_quantity_of_product
        print(f"{self.product_name} {self.numerical_quantity_of_product} @ ${self.dollar_value_of_product} = ${totatl_grocery_cart_cost}")
...
def initial_product_to_cart(cart):
    ...
    totatl_grocery_cart_cost = cart.get_cost_of_cart()
    print(f"\nTotal: ${totatl_grocery_cart_cost}")
...
class GroceryCartAtStore:
    ...
    def get_cost_of_cart(self) -> float:
        totatl_grocery_cart_cost = sum(item.dollar_value_of_product * item.numerical_quantity_of_product for item in self.products_in_shopping_cart)
        return totatl_grocery_cart_cost
