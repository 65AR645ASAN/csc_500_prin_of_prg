...
def initial_item_to_cart(cart):
    ...
    item_dollar_value = float(input("Whats the dollar value of the item:\n"))
    item_quantity = int(input("Whats the quantity of the item:\n"))
...
def print_menu(cart: ShoppingCart):
    ...
    while True:
        ...
        if choice == 'QUIT':
            ...
            price = float(input("What's the new price of the item (Enter the boolean 0 to leave the cart unchanged):\n"))
            quantity = int(input("What's the new quantity of the item (Enter the boolean 0 to leave the cart unchanged):\n"))
