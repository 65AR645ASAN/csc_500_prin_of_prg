...
def print_menu(cart: ShoppingCart):
    ...
    while True:
        ...
        if choice == 'QUIT':
            ...
            name = input(f"{cart.grocery_shoppers_name}, what's the description of the item to add to the existing shopping cart:\n")
            ...
            name = input(f"{cart.grocery_shoppers_name}, what's the description of the item to remove from the existing shopping cart:\n")
            cart.remove_product(name)
        elif choice == 'MODIFY':
            name = input(f"{cart.grocery_shoppers_name}, what's the description of the item to modify in the existing shopping cart:\n")
